...
class ElkanotoRFConfig(PULConfig):
    @classmethod
    def build_pipeline(cls):
    ...
    def build_param_grid(cls):
        param_grid = {
            ...
            'elkanoto__estimator': [
                ...
                RandomForestClassifier(n_estimators=250, max_depth=None, max_features="sqrt"),
                RandomForestClassifier(n_estimators=500, max_depth=None, max_features="sqrt"),
                RandomForestClassifier(n_estimators=100, max_depth=1, max_features="sqrt"),
                RandomForestClassifier(n_estimators=250, max_depth=1, max_features="sqrt"),
                RandomForestClassifier(n_estimators=500, max_depth=1, max_features="sqrt"),
                RandomForestClassifier(n_estimators=100, max_depth=10, max_features="sqrt"),
                RandomForestClassifier(n_estimators=250, max_depth=10, max_features="sqrt"),
                RandomForestClassifier(n_estimators=500, max_depth=10, max_features="sqrt"),
            ]
        }
        return param_grid
