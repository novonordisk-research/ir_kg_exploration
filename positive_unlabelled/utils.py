...
def build_proba_df(grid_searches, input_dir, gene_df_file='./data/gene_df.csv', mns=['RotatE', 'TransE', 'CompGCN']):
    ref_df = pd.read_csv(input_dir / 'ref_df.csv', index_col=0)
...
def build_proba_df_obl(grid_searches, input_dir, gene_df_file='./data/gene_df.csv', mns=['RotatE', 'TransE', 'CompGCN']):
